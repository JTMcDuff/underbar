(function() {
  ...
  _.defaults = function(obj) {
    ...
    for(var i = 0; i < arguments.length; i++){
      for(var bossKey in arguments[i]){
       if(!_.contains(arrayKey, bossKey)){
        obj[bossKey] = arguments[i][bossKey];
        arrayKey.push(bossKey);
       }
      }   
    }
    return obj
  ...
  _.delay = function(func, wait) {
    var argDelay = Array.prototype.slice.call(arguments, 2);
    setTimeout(function(){
      func.apply(this, argDelay);
    }, wait);
  };
  ...
  _.shuffle = function(array) {
    var current = array.length, index, temp;
